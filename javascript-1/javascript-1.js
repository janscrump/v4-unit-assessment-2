...
let newAnimal = 'elephant'
const animalsCopy = [...animals, newAnimal]
...
//CODE HERE
  let phone1 = new Phone ('nokia', 'nokia1', 10, 'black', false)
    
  let phone2 = new Phone ('apple', 'X', 20, 'white', false)
  
  let phone3 = new Phone ('samsung', 'galaxy', 25, 'grey', false)
